...
<div style="margin:5px 0px 100px 0;text-align:center; width:100%;">
    <p align="center">
        <?= $trl->translate('TEXT_LOGIN_VIEW_STATUS_OF_TICKET') ?>
    </p>
    ...
    <table cellspacing="1" cellpadding="5" border="0" bgcolor="#000000" align="center">
        <tr bgcolor="#EEEEEE"> 
            <td><?= $trl->translate('LABEL_EMAIL') ?>:</td><td><input type="text" name="lemail" size="25" value="<?=$e?>"></td>
            <td><?= $trl->translate('LABEL_TICKET_NUMBER') ?>:</td><td><input type="text" name="lticket" size="10" value="<?=$t?>"></td>
            <td><input class="button" type="submit" value="<?=$trl->translate('LABEL_VIEW_STATUS')?>"></td>
        </tr>
    </table>
    </form>
</div>
